//---------------------------------------------------------
// Device_S1.h
// Verbaute Sensoren: UV, Helligkeit, Temperatur
// Typ: HB-UNI-Sensor1.ino
//
...
#define cDEVICE_ID      { 0xA5, 0xA5, 0x04 }
#define cDEVICE_SERIAL  "UNISENS004"
